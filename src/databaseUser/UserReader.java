...
public class UserReader {
	...
	/**
	 * Create FYP Coordinator object to let all users store it
	 */
	...
	private void init_database() {
		read_csv_to_records("databases/FFYP_coordinator.csv", "FYP");
		read_csv_to_records("databases/Fstudent_list.csv", "student");
		read_csv_to_records("databases/Ffaculty_list.csv", "supervisor");
	}
